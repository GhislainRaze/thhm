...
l = 3;
phir = pi/2;
cstrType2 = 1;   % Constant force
[XTH,LambdaTH,bm,bl,xI,wI,fI] = thhm(X,Lambda,m,l,phir,cstrType2,f,fext,Ndofs,Nh,A0,A1,A2,NL,Gamma,NFT,SC);
